...
With help of one research assistant and her team (one female field worker who also became one of the adult subjects in the study), the researcher managed to recruit a total of fourteen adult participants (beneficiary users) through a convenience sampling technique. By the researcher in the context of this chapter I mean myself. In cases where I use ``we'', it implies there was a cooperation between the researcher and research assistant's team in doing the work. The research assistant's team approached potential participants for the study at the beginning of  October 2015. The research assistant's team recruited participants from two townships in Cape Town, namely Langa (where the research assistant resided), and Athlone (where the field worker resided). The research assistant was coordinating the whole process while the field worker was assisting her. In Langa there were five (5) adult participants while in Athlone there were nine (9) adult participants. There was only one male out of fourteen adult participants. It was easier to  recruit females than males as females were more eager to participate than males. This resulted into the gender imbalance on adult participants that we recruited.  The study in Chapter \ref{prototype2chapter} also showed this trend of gender imbalance with more females present. The average age of these adult participants was 44.21 years with a standard deviation (S.D) of 9.99 years. The age range was between 26 and 60 years of age. The highest education level among adult participants was secondary school while the lowest was the last grade of primary school. After recruitment of adults. 

The research assistant's team notified adult participants before recruitment that one of the requirement to be part of the study is to have a family member preferably a school going child willingly to be part of the study. Each adult participant we recruited, elected/brought one of their children/grand children to become their respective intermediary user. Therefore, the two people, an adult, and child, were to form one pair of users. As the result, we had fourteen children in the study. Thirteen adult participants teamed up with their children, the remaining one adult teamed up with her grand child. Children participants had a mean age of 15.42 (with a standard deviations of 2.06 years). The age range children participants was between 12  and 20 years of age. There was a gender balance on intermediary participants. 

The researcher visited the two research sites on different occasions (days) to talk to all participants (adults and children). In these meetings, I gave out detailed information of what the study was all about to both intermediary and beneficiary participants. I informed them about different modes of which I would be collecting data. The data collection approaches included usage logs, questionnaires, and interviews ( more details on Sub-section \ref{datacollect} -- \textbf{Data Collection and Analysis}). All the beneficiary participants signed informed consent forms agreeing to be part of the study. Since all intermediaries were under 21 years of age (legal age for giving consent in South Africa is 21 and above), they signed assent forms which were also signed by their respective parents/guardians who were part of the study.

I allocated one day for training all intermediary participants on how to use the ``Family Wellness App''. I conducted training in Athlone (one of the research site). The research assistant and her team organized transport for children from Langa (the second site) to be able to attend this meeting in Athlone. The reason of why we brought the children/kids together was, first to make kids become acquaintance to each other (This would be instrumental in gamification). Secondly, it was a good idea to train all intermediary participants at once so that they start using the ``Family Wellness App'' immediately after the training. During the training, each intermediary participant/user received a user manual. After the training, the researcher assigned one Android phone (Samsung GT-S5300) to each pair of participants; hence children collected these phones on behalf of their parents. The researcher installed two native apps in each phone, which were the pedometer app, and the main ``Family Wellness App''. The ``Family Wellness App'' loaded all its content from a web application (app). I hosted the web application at University of Cape Town. There were two versions of the web app. I have described the details of these two versions on ``Experiment Design'' section (\ref{exp_design}) below. Each beneficiary participant had to carry around the phone that was given to a pair in order for the pedometer app to count their footsteps. Participants had six week to use the two apps (main app and pedometer) . Each pair of participants provided the phone number of the SIM card that would insert on their given Android phone. I allocated 1.3 GB of data to each SIM card. In addition each beneficiary participant was given a total of ZAR (South African Rands) 240 ($\approx$ USD 20) for the duration of the study. That amount of money covered for compensation for participants' transportation and time spent in data collection activities such as administering of questionnaires and interviews. The details of the experiments are as outlined on the next section. 

\section{Experiment Design}\label{exp_design}
The research objective focused on evaluation of the effectiveness of gamification in promoting  intermediated use in the context personal health informatics. As the result, the experiments entailed comparisons between the app that was not gamified and the gamified app. The non-gamified app was simply a diary/logbook that enabled individual pairs of participants  to track diet/nutritional components of meals that a beneficiary participant consumed. The logbook also enabled  pairs to track footsteps of a respective beneficiary member of a pair. The second version of the application was an extension of logbook; it included all the features in logbook  with an addition of a rewards/gamified subsystem. The details of the system are provided on the previous chapter (Chapter {prototype2chapter}). I carried out the experiments from mid-October 2015 to the end of November 2015.

I opted to use the ``within-group'' approach for the experiment design. In this approach there are no fixed control/intervention groups as the same group subjects would have a chance to experience both control and intervention conditions. The rationale of opting this design approach is that it reduces interference from confounding factors. The second benefit is that it reduces cost of recruitment as the same group would appear in both control and intervention conditions. This approach could also be of benefit in ICTD context. Recruitment of participants one of the daunting tasks in ICTD studies~\citep{anokwa2009stories,ramachandran2010research}; this may compromise the rigour of such studies~\citep{ramachandran2010research}. Therefore the ``'within-group'' approach offer benefits in terms of increasing the power of a study by using only half of the number of subjects/participants that would have been required in a typical control/intervention study.

I created two experimental conditions one referred to as logbook condition and one referred to as gamification condition. Then I used the same group of subjects for both logbook condition and gamification condition. There is a caveat in using this approach, the learning effect could affect the rigour of the findings  if all participants start together in one experimental condition and thereafter switch to the other experimental condition. This could have favoured any experimental condition that is starting first (predecessor), and make the one that finishes last (successor) to be on the disadvantage side of the learning effect. I dealt with this particular issue by creating experimental sequences as I have highlighted on the next paragraph. 

I divided pairs of participants into two separate groups. The difference between these two groups was on the order in which experimental conditions start and finish.  I referred to each of these modes of starting and finishing as an experimental sequence. Therefore each group had a unique experimental sequence. I labelled these two groups as ``LG'' group and ``GL'' group.  In the ``LG'' group, pairs of participants started with logbook and later they switched to gamification condition. In the ``GL'' group, pairs of participants pairs that started with gamification condition and later they switched to logbook condition. I designed the experiment for switching of experimental conditions to happen at midpoint. This formation of experimental sequences prevented bias in how the learning effect could have affect individual experimental conditions. The anticipation was to have the opposite cancellation of the learning effect as each experimental condition is present before midpoint and after midpoint. One drawback of within-group approach is that it makes the duration of experiments much longer; this could be exhaustive to research participants. However, this was an added advantage in the context of this research since the study was trying to understand susceptibility on sustained usage in  between system using logbook and system using gamification.

A total of seven pairs of participants were assigned to the LG group while the remaining seven pairs were assigned to the GL group. Initially the plan was to have the time spent on each experimental condition, be in three(3) weeks intervals, but phase 1 had extended beyond its allocated block of three weeks up to the fourth week as pairs of participants were not available for midpoint assessments at the end of the third week. Therefore, I carried out the midpoint assessment at the end of the fourth week. After the aforementioned assessment, pairs that were in gamified app were switched to logbook app, and those that were in logbook app were switched to gamified app. It was not feasible to extend phase 2 to go up to four weeks as phase 1 because it was approaching December of where most people travel for holidays, therefore, gathering participants during that time may have been impractical. As the result this shortened the duration of phase 2 to two weeks. These kind of eventualities pervade in field research within ICTD context. Researchers have argued that even though eventualities may appear to affect rigour of research, such compromises offer benefits as they tend to preserve contextual interactions which are key to facilitation of an intervention~\citep{anokwa2009stories,ramachandran2010research}. Through the course of doing a series of studies reported in previous chapters up to the current reported study, things have not been always going according to plan as there have been periods of where compromises and constant negotiations had to be done; these contextual aspects were vital to make this intervention/research a success. Therefore, within the contexts of this research, trade-off between varying contextual factors and rigour of the methods is an important aspect that made this study possible. Examples of such negotiations were on issues to with location (meeting points for interviews), availability of participants, etc. As the result, all the takeaways and contribution made by this study are still valid when considering the arising need to preserve social relations that were crucial in execution of this field work.
\section{Data Collection and Analysis}\label{datacollect}
I carried out data collection through a triangulation of application's usage logs, questionnaires, and interviews. Questionnaires and usage logs resulted into generation of quantitative data while interviews yielded into generation of qualitative data. Triangulation of different methods is important when doing research in ICTD context as it strengthens the reliability of the findings~\citep{burrell2009constitutes}.

I analysed quantitative data using both descriptive and inference statistics. Before each inferential statistical test, I tested data points to find if they follow normal distribution. The test that I applied to check for normality was ``\emph{Shapiro-Wilk Normality Test}''\footnote{http://sdittami.altervista.org/shapirotest/ShapiroTest.html}. I have outlined major decisions in choosing statistical tests as follows.
\begin{enumerate}[label=(\alph*)]
\item  Part of quantitative data consisted of sets of data with paired samples (two dependent samples) used for analysis. On deciding what statistical test to use, the first step was to test normality of the difference between repeated measures of each data point. If there was no normality, I would apply a log transformation on the original data, and repeat the normality test again. For cases where the data assumed normality I used parametric tests such as student-t test with repeated measures. All the sets of paired samples achieved normality on either original data or transformed data; as the result non-parametric tests where never used in cases of sets of two dependent samples.
\item Quantitative data also consisted sets of data with three dependent samples. In the first step, I paired each sample to one sample from the same set. This process created three pairwise samples. Then  I used the same procedure to check for normality in two dependent samples. In all cases of where there were three dependent samples, there was normality on the original data; hence the data didn't need any transformation. As the result I ended up using one way ANOVA with repeated measures in all cases where there were three dependent samples.  
\item The third part of quantitative data sets consisted of two independent samples. I did the normality test on each independent sample. In the absence of a normal distribution in any of the two independent samples, a log transformation was applied in this context. In some cases, data followed normal distribution. In such cases, I used a student-t test with no repeated measures. There was one case of two independent samples that didn't adhere to the requirement of normal on either original data or transformed data. In that case, I resorted to the use a Mann-Whitney U test -- a non-parametric test\footnote{Mann-Whitney test is a non-parametric test for independent samples}. 
\end{enumerate}
The next subsections provide details of each of the three methods in this study. 
\subsection{Family Wellness App Logs}
\subsubsection{Generation of Usage Logs}
The web application captured usage logs on the client side through JavaScript events.  The app generated events when users touch/click links that load features/functionality on the app. Asynchronous JavaScript (AJAX) transferred all events to the server for storage on a database. AJAX transferred events to the server after wrapping them into JSON (JavaScript Object Notation) format. Each object mapped pair's identity to events in order to know to whom events belong to. Figure \ref{figure:events_logs} shows the logical organization for capturing, transferring, and storage of events.
\begin{figure}[htbp]
  \centering
...
\end{figure}
Before sending out events, the client stores them temporary  until the user  moves from one functionality to the other. Then AJAX would send out past events that the client program had already stored in its variables. Due to this delay, the server program was not recording events in real time. This approach of delaying until the user accesses the next feature was intentional in order to minimize the frequency of data transfers between clients and server. But this delay didn't affect the ability to understand behaviour pattern on usage. 

However one would argue why I didn't choose to capture client's clock time on the client side during the capturing of events. Recording of phone's time on the client side had its limitations. There were periods of where the dates on experimental phones were not correct. I had learned in previous studies (Chapters \ref{prototype1chapter}, and \ref{prototype2chapter}) that participants had a tendency of removing SIM cards from their phones and this would require removing of batteries. After removal of a battery, a phone would lost its clock time. Hence if a user tries to access the app immediately then time recordings would be incorrect. For instance the Android phones I was using for experiments would set date and time to the default one, from the manufacturer. I noticed this pattern by looking at the logs from a pedometer. There were time where a pedometer reported fewer incorrect clock's time readings. I confirmed about this behaviour of changing SIM cards during interviews reported in Chapters \ref{prototype1chapter}, and \ref{prototype2chapter}. Therefore, because of the above stated reasons, I made a decision to capture time of events on the server side. 

Once events arrive on the server side, the server side program written in python would attach arrival time and stores those events into a database. Therefore, the database kept information such as; when there were users' activities on the app, which pair was accessing the app at that time, and what functionality/feature a pair accessed. The system also categorized events to their respective experimental conditions.  
\subsubsection{Analysis of Usage Logs}\label{log_analysis}
Through analysis of events that the app was able to capture, I was able to synthesize usage in two useful dimensions: (1) the number of usage sessions in each pair of participants ; and (2) the number of views on certain features  from each pair of participants, which is in this context I refer to it the ``number of impressions''

I defined a new session as a period of detection of user's activity inside the app in an absence of any activity from this particular user/pair in the past one hour or more. The term impressions is commonly used in social network platforms (i.e. Instagram) to describe views on user's status (i.e. photo, video, etc.). Therefore in this context, I define impressions as the number of times in which a certain feature had been viewed by a pair. So if multiple clicks by one user/pair on one feature happened within an interval of less than one minute between two consecutive clicks on the same feature, such multiple consecutive clicks were grouped as a single impression. If clicks on the same feature differed by a minute or more then I considered the current click as a new impression while the previous click belongs to the previous impression. Therefore, if the time difference between clicks on the same feature is beyond one minute, then it was assumed that the user had gone away or move to a different feature and they are coming to this feature for another iteration of clicks on the feature as the previous iteration of clicks within that feature they are visiting had finished. The purpose of computing pair's total impressions on each feature was to understand where users of the app were likely to go among many options of gamification features. i.e. leaderboard (score board), score badge, botanical garden, and fish tank (fish aquarium). 
 
Data on number of, impressions and sessions resulted into two major analyses of usage logs. 
\subsubsection*{Comparison of Usage Sessions Between Logbook and Gamification}
This particular analysis was of twofold.
\begin{enumerate}[label=(\alph*)]
\item \textbf{Comparison of Daily Total Sessions Between Logbook and Gamification}
\end{enumerate}
In the first aspect of this comparison, I obtained the daily total number of sessions in each experimental condition, through adding sessions from all users in an experimental condition. I repeated this process for all 41 days of running experiments using the format of Table \ref{table:totaldailysessions}. As the result there were 41 data points. I then compared daily total sessions of between logbook and gamification. I treated each experimental condition as an independent variable. I also treated total number of sessions from all users in a particular experimental condition as a dependent variable.    
...
The statistical test that I applied to do the aforementioned comparison is Mann-Whitney U Test. I have highlighted above at the beginning of this section (\ref{datacollect}) of how arrived into the decision of choosing one among different tests in each case of inferential statistical analysis) 
\begin{enumerate}[label=(\alph*)]
\setcounter{enumi}{1}
\item \textbf{Comparison of Sessions Between Logbook and Gamification in Each Pair}
\end{enumerate}
I conducted the second comparison between sessions in logbook and gamification at the level of performance of individual pair of participants. In this comparison, I was looking at how each pair performed in logbook and gamification (repeated measures for usage during logbook and usage during gamification by the same pair of users).  The number of days spent on experiments prior to midpoint assessment (4 weeks) was not the same the number of days spent on experiments after midpoint assessment (2 weeks). Therefore, it was not fair to compare between an experimental condition was available 4 weeks and an experimental condition that was available for only 2 weeks, for instance if a pair would have started with Logbook then they would have spent 4 weeks in logbook and 2 weeks in gamification. The same reasoning applies for a pair that started with gamification. In order to bring fairness in comparison of number sessions of the same pair of participants in between two experimental conditions, I opted to use a relative (normalized) number of sessions  as a unit of measurement. The formula I used for the normalized number of sessions is as shown below.
\begin{mdframed}[style=MyFrame]
$$T_{mj}=W_{mj}/D_{mj}$$
\end{mdframed}
\textbf{where}:

$T_{mj}$ is number of sessions per day for a pair $m$ in experimental condition $j$,


 $S_{mj}$ is total number of sessions for a pair $m$ in experimental condition $j$, and

$D_{mj}$ is total number days on which pair $m$ could access experimental condition $j$ (27 days $\approx 4$ weeks if the experimental condition started before midpoint and 14 days = 2 weeks if the experimental condition started after midpoint).
%\noindent

I formulated an hypothesis with the aim of understanding the difference in usage sessions for the same pair of participants, when in logbook and when in gamification.
...
For \textbf{Pair-A}, the app failed to load every time the intermediary user tried to use it. The intermediary user from this pair sent a message to the researcher, complaining that the App was unstable as he couldn't start it most of the time. After a follow up, the researcher observed that in the house where this particular pair lived in there was a poor Internet signal, hence the app was always failing to load most of the time and this frustrated the intermediary user.

For the second pair (\textbf{Pair-B}) on Table \ref{table:usageproblems} ,The researcher sent Internet data bundle to the wrong phone number. The researcher was using Internet banking to buy Internet data, and send them to individual phone numbers. In this case, a pair provided a phone number of a SIM card that belonged to a relative. Therefore, they had put on the experimental phone a SIM card with phone number that was different from the one they provided to the researcher during the orientation/training of the app. The researcher allocated Internet data to the wrong phone number at the beginning of the experiments but they never reported on time. When the researcher met them for interviews they claimed they had not received data bundles. Upon showing the phone number of where the research sent Internet data, they recognize it as the phone of their relative. The problem was break down of communication as the pair didn't understand researcher's instruction  about phone numbers. However, these two pairs (Pair-A and Pair-B) had the lowest usage days which were 2 and 3 days respectively of which usage happened only in gamification condition. Therefore, the researcher never foresaw that lack of Internet data attributed to their infrequent usage. There was a possibility of making a phone call to participants, but the researcher didn't prefer  this approach as it would have introduced confounding effect. Asking participants why there are not using the system would appear nudging and it would influenced behaviour of participants. Hence the research relied on receiving queries from participants like in the case for an intermediary user in \textbf{Pair-A} who made an effort to contact the researcher. Also I have provided additional on the last paragraph of this section of why it was difficult for the researcher to receive this information on time.
...
Removing these four pairs was advantageous as it reduced confounding noises. Confounding noises had tendency of favouring one experimental condition over the other. The logic behind bias as an outcome of technical difficulties is as follows. These users/pairs started to experience these hurdles at the beginning of the experiment. But two pairs still had access to the web app throughout the experiments. The remaining two pairs failed to continue with usage the web application because of either not having internet data  or the app failing to load. Phase 1 of the experiment had the advantage of the novelty effect; hence the pairs that could still access the web application (\textbf{Pairs-C} and \textbf{Pair-D}) on Table \ref{table:usageproblems} continued to do so despite the presence of technical glitches that affected transmission of pedometer data to the server. However after the app usage stabilized this novelty effect diminished. The implication of this is that phase 2  had a disadvantage of meeting the learning effect coupled with technical glitches. Taking this into consideration, it is clear that the four pairs had more sessions in phase 1 than in phase 2 regardless of their respective experimental conditions. Therefore, I arrive to the solution excluding these pairs from the analysis of usage sessions. As the result this increased the power of the study to detect statistical significance difference on usage sessions between logbook and gamification.

There were a lot of logistical constraints and break down of communication between the researcher and participants. Being a foreigner, disadvantaged the researcher's ability to use public transport to visit unfamiliar locations due safety issues. The researcher required to hire private transport in order to visit participants in study sites. There was one location in each study site of where the researcher would meet with participants from a a particular site. These meeting points were both resident houses of research assistant and field worker in Langa and Athlone respectively. On the day of a visit, participants would gather to a meeting point near their neighbourhood. Planning of these visits was a daunting task. This posed a challenge to frequent visits to the field.  As the result, the researcher had only four meetings with participants. In case of technical difficulties, it was hard for the researcher to know what was going on. And when the researcher discovered about some technical challenges I could fix (i.e pedometer), it was already too late. \citep{anokwa2009stories} have also discussed how ICTD researcher face challenges to accessibility of research sites.  
\subsubsection*{Discerning Relationship Between Usage of Gamification Features and Internalization}
...
The term ``impressions on a feature/functionality'' is pair's frequency of viewing a particular feature (Refer to the definition in Sub-section \ref{log_analysis}).  Each pair of participants had the total number of impressions for each of gamification features.

In this analysis, the researcher considered all fourteen pairs including the four that had technical glitches. Since this comparison only involved one experimental condition; then pairs could access any gamification features equally. So if the user failed to use the app then that would also be failure to use all gamification features.  If the user manages to get into the app, then the user could visit any  gamification feature they wanted. This means technical glitches didn't favour any gamification feature to be specific. If there were technical glitches then they would have affected the entire gamification features instead of only affecting some features. Therefore, if user with technical glitches accessed  gamification, then the effect is malfunctioning was the same for all gamification features. 

Another reason of considering all gamification users is that the system delivered some feedbacks through SMS meaning that such messages were delivered to all pairs without failure. As the result pairs had some form of interaction with the gamified app regardless of whether the App was directly accessible or not.  Therefore, it is under the assumption that all pairs that had received SMS feedback could be in position of judging the perceived usefulness of the app. In addition to that, intermediary users were frequently interacting to one another in face to face manner to talk about things in the app.  The researcher also made an assumption that regardless of the app presence, intermediary users would perceive helping their parents on app usage as something that was meaningful. Hence if the user/pair had never viewed a particular gamification feature, they would still get zero as the number of impressions in that feature. The objective was to understand how gamification features affected internalization. Literature review section (Chapter \ref{literaturereview} highlighted four types of internalization of behaviour regulation. Therefore, this analysis also viewed internalization with respect to the four types of behaviour regulation. The next sub-sections discusses in details about questionnaires that the researcher used to capture aspects of internalization (perceived usefulness). The next sub-sections also brings questionnaires about more sub-scales of intrinsic motivation.

\subsection{Questionnaires}\label{methodsquestionnaire}
The research team administered questionnaires at baseline, mid-line (during switching of experimental conditions), and end-line. These questionnaires targeted both intermediary and beneficiary participants. The list of questionnaires that are described below are attached at the Appendices  C and  D.
\begin{enumerate}
...
Since perceived usefulness is the only predictor of internalization (Refer to the discussion about questionnaires on Sub-section \ref{methodsquestionnaire}), therefore, one of the logical steps was to compare perceived usefulness scores between intermediary users who had visited leaderboard more often than other gamification features (number of impressions in leaderboard is greater than the number of impressions on any of the other gamification features) and those intermediary users whose number of impressions on leaderboard was almost similar or less to the number of impressions on any of the other gamification features. Since the average number of impressions on botanical garden, score badges, and fish tank were not so distant from one another as indicated on Figure \ref{figure:gamification_impressions_latest_all}, I selected only the botanical garden as a point reference (to represent features that may promote task master climate) for comparison with leaderboard(to represent those features that may promote ego-involved climate). 

Perceived usefulness was about how intermediaries rated the usefulness of the app to them and their parents. An assumption is that if the regulation is introjected then the intermediaries would careless about usefulness of the app. Therefore, the next task was to compare perceived usefulness between those intermediary users with high leaderboard impressions relative to the botanical garden and those with low leaderboard impressions relative to the botanical garden. In order to know whether an intermediary user falls under high or low group, the ratio was computed and this ratio was the number of impressions on leaderboard divide by the number of impressions on botanical garden. Two group were formed based on the median of ratios from all fourteen intermediary user which was $0.91$. Seven intermediary users were assigned into a group with $ratio>=~Median$ while the remaining seven intermediary users where put under a group with $ratio<Median$. Therefore, the comparison was done on perceived usefulness of the gamified app between intermediary users with $ratio \text{ of } impressions~>=Median$ and intermediary users with $ratio \text{ of } impressions~<~Median$. The two independent samples followed a normal distribution; hence the results  of a student t test are shown on Table \ref{table:pu_leaderboard_bias}) which indicates that the group with $ratio~<Median$ scored significantly higher in perceived usefulness that the group with $ratio>=Median$. The implication of this finding is that those that had never accessed the leaderboard or had accessed it fewer times relative to the botanical garden had a higher tendency of valuing the intervention that utilized the gamified app as useful compared to those that had used the leaderboard relatively higher than the botanical garden. 
...
Since the bias on usage of leaderboard showed the significant decrease of scores on perceived usefulness, the next task was to see if that affected gamification condition in general. Let's examine the trend of intermediaries' perceived usefulness between midpoint and endpoint between for both a group with $ratio >=~Median$ and ratio~\textless~\textbf{Median}. An earlier assumption was that the relationship between parents and children would make children to value the app as meaningful; hence the regulation would be considered as either identified or integrated regulation. But from the findings above, the trend indicated that most users concentrated on the leaderboard and as the result those with higher number of impressions of leaderboard compared to number of impressions on other gamification features such as the botanical garden appeared to have low scores in perceived usefulness.

In order to verify the significance of the aforementioned trend on impressions,  the hypothesis of interest was that gamification affected the perceived usefulness of the app through its leaderboard feature.  The first logical step I did was to assess perceived usefulness between midpoint and endpoint for the two aforementioned groups. The perceived usefulness was statistically significant higher at endpoint (Mean = 5.4, S.D = 1.058) compared to midpoint ($Mean=4.67$, $S.D=1.37$) ($t(6)=4.9670$, $p=0.0025$) for the group with $ratio<Median$ while for the group with $ratio>=Median$, there was no statistical significance difference between endpoint ($Mean=4.34$, $S.D=1.081$) and midpoint ($Mean=4.66$, $S.D=0.781$) ($t(6)=0.8742$, $p= 0.4156$). An intermediary user with the highest ratio, was the one with the lowest scores on perceived usefulness. There was a negative correlation between ratio of impressions (leaderboard/botanical garden) and perceived usefulness without statistical significance ($r=0.52$, $p=0.06$, $N=14$).

What can be concluded so far from the trend on ''number of impressions'' is that it is very likely the leaderboard played a role in hindering internalization since perceived usefulness is a good predictor of internalization. Also high usage of leaderboard suggests most usage in gamification was accounted as introjected regulation of where there is ego-involved. The presence of introjected regulation is supported by the excerpt below from one participant but it also emerges in most of the excerpts of users while in gamification condition. Therefore, usage in such cases was mostly influenced by the desire to dominate others in the competition. Therefore, these different analyses support the conjecture of Figure \ref{usagedailysessions} about the presence of introjected regulation due to a sudden drop is usage of pairs in ``GL'' group  after day 27. If internalization was on the levels of identified and integrated regulations, then there would have been no sharp drop but a steady drop.  

\userquote{\textbf{Ayesha}, a beneficiary working with her son, 35 yrs} {``We [with Keagan] were not talking to others because all we wanted was to win. We didn't want them to know but they could see from the app''}~\citep{katule2016family}
...
\userquote{\textbf{Sisipho}, a beneficiary working with her son, 43 yrs} {``I always start the conversation. Because I always want to make sure if he records because I can't use it. It was difficult for me to use it. [during logbook]''}~\citep{katule2016family}

The ``Gamified App'' was designed in such a way that a pair will earn rewards based on usage and the average number of steps walked by a beneficiary participant who is a member of the pair. The purpose of rewards was to foster users' intrinsic experiences such as competitiveness and a sense of autonomy which are predictors of intrinsic motivation with the goal of improving collaboration between members of a pair. Rewards depended on four parameters and these were the number of recorded footsteps walked by a beneficiary user, the number of days the app has been used by an intermediary to either to record meals or to view feedback on meals, points, steps, gardens, etc. The presence of gamification nurtured  team work  even though the regulation of self-monitoring through intermediary users was mostly introjected (regulation done for the purpose of becoming better than others) as shown on below excerpts.

\userquote{\textbf{Keagan}, an intermediary for his mother, 16 yrs} {``When I see other people trying to come above me [on the leader board]. I hand over the phone to my mom so she can walk more steps.''}~\citep{katule2016family}

\userquote{\textbf{Christine}, an intermediary for her mother, 16 yrs} {``I told my mom that me myself I want our team to have the highest points. Yes she said she is going to do that.''}~\citep{katule2016family}
...
\hline	\end{tabular}
  \end{center}
\end{table}
A finding from a pairwise comparisons (a paired student t-test) indicated that the IMI score at endline was significantly higher than at baseline (Table \ref{table:imipairwisediet}). The difference among baseline, midline, and endline was not significant (Tables \ref{table:imipairwisediet1}, and \ref{table:imipairwisediet2}). Motivation to self-monitor diet appeared to increase with time as shown on Figure \ref{figure:imi_diet}. The interpretation of the above findings are that the wellness app appeared to had a significant effect of time on motivation of beneficiaries to self-monitor their diet.
\begin{table}[h!]
  \begin{center}
...
The contribution of this chapter is on understanding the role of gamification in increasing collaboration between an intermediary user and beneficiary user. I have discussed of how gamification could be effective through the roles it plays in fostering or preventing internalization. Leaderboard is the main source of introjected regulation; hence it prevented integration of helping in self-monitoring tasks. Generally, gamification appeared to increase collaboration between members of a pair. This collaboration seemed to strengthen bonds which is crucial for future negotiation of interaction between an intermediary user and beneficiary user. However in some scenarios of excessive competition through the leaderboard, gamification created tension that threatened to harm the relationship between an intermediary user and beneficiary user. This happened in cases where an intermediary user felt that non-complying behaviour (i.e. forgetting to carry the the phone running the pedometer) of their respective beneficiary user was letting down the all team.  This also brings the discussion of personalities, how they are important to match with gamification features that support them.

In this chapter, it is also clear of how a confounding factor such as sharing phones could also play a role in increasing collaboration. I argue that such confounding variables should not be viewed as affecting the rigour of the study but as contextual facilitators of an intervention. However, since the experiment design was within-group, then such confounding factors affected the same intermediary users in both experimental conditions; hence didn't affect any comparison of the same pair with repeated measures. It could have have affected the analysis reported on Table {table:usagedays}, but since other analyses (i.e. Table ) showed gamification is superior then results of Table \ref{table:usagedays} are still valid.  Designers of collaborative systems such as the one in this study need to take all the discussed factors into consideration in order to design a system that is emotionally engaging in a positive way.
\begin{flushright}
\end{flushright}
